...
* Check the `ConnectionStrings` in `appsettings.json` files under the `AbpSolution1.HttpApi.Host` and `AbpSolution1.DbMigrator` projects and change it if you need.
...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 1f7c1b08-0c48-4847-95f7-75b2b594ebd5
```

> `1f7c1b08-0c48-4847-95f7-75b2b594ebd5` is the password of the certificate, you can change it to any password you want.
